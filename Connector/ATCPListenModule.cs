...
namespace Nano3.Net
{
    public class ATCPListenModule : IHostConnectionModule
    {
        ...
        public ATCPListenModule(long moduleID, int connectorReceiveBufferSize = NetHelper.READ_BUFFER_NORMAL, int backLog = 100)
        {
        ...
        private void OnAcceptCallback(IAsyncResult ar)
        {
            ...
            try
            {
                if (sock != null){
                    ...
                    conn = new AsyncTCPConnector(sock, Uid64.CreateNewSync().Data, NetHelper.READ_BUFFER_BIG);
