...
namespace Nano3.Net
{
    public class Protocol_12 : IProtocol
    {
        ...
        private const string UID = "AD707037FBA15901";
        private static readonly long BWORDKEY = Uid64.LoadFromString(UID).Data;
        ...
        public Protocol_12(Uid64 startWord)
        {
            _startWord = startWord.Data;
            _bword_Array = BytePacketReader.GetBytes(_startWord);
        }
